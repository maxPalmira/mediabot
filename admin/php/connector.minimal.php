...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../../films/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../films/', // URL to files (REQUIRED)
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../films/.tmb/',
			// 'trashHash'     => 't1_Lw',                     // elFinder's hash of trash folder
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('video/mp4'),// Mimetype `image` and `text/plain` allowed to upload
		...
		array(
            ...
            'path'          => '../../thumbnails/',
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../thumbnails/', // URL to files (REQUIRED)
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../thumbnails/.tmb/',
			'accessControl' => 'access',                     // disable and hide dot starting files (OPTIONAL)
            'alias'         => 'Thumbnails',
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadMaxSize' => '2G',
		...
		array(
			...
			'driver'        => 'Trash',
			'path'          => '../../films/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../../films/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
